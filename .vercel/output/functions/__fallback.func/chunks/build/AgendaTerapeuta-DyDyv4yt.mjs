...
import { ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrRenderComponent, ssrRenderTeleport } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "agenda-terapeuta p-6 max-w-7xl mx-auto" }, _attrs))} data-v-37d8b05d><div class="flex items-center justify-between mb-6" data-v-37d8b05d><div data-v-37d8b05d><h1 class="text-3xl font-bold text-gray-900 mb-2" data-v-37d8b05d>Mi Agenda</h1><p class="text-gray-600" data-v-37d8b05d>Gestiona tus citas y sesiones</p></div><div class="flex items-center gap-2" data-v-37d8b05d><div class="flex bg-gray-100 rounded-lg p-0.5" data-v-37d8b05d><button class="${ssrRenderClass([vista.value === "calendario" ? "bg-white text-gray-900 shadow-sm" : "text-gray-600 hover:text-gray-900", "px-3 py-1.5 rounded text-sm font-medium transition-colors"])}" data-v-37d8b05d> Calendario </button><button class="${ssrRenderClass([vista.value === "lista" ? "bg-white text-gray-900 shadow-sm" : "text-gray-600 hover:text-gray-900", "px-3 py-1.5 rounded text-sm font-medium transition-colors"])}" data-v-37d8b05d> Lista </button></div>`);
      if (vista.value === "calendario") {
        _push(`<div class="flex items-center gap-1 ml-2" data-v-37d8b05d><button class="p-2 rounded hover:bg-gray-100 text-gray-900" title="Semana anterior" data-v-37d8b05d> \u2190 </button><button class="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 rounded text-sm font-medium text-gray-900 transition-colors" data-v-37d8b05d> Hoy </button><button class="p-2 rounded hover:bg-gray-100 text-gray-900" title="Semana siguiente" data-v-37d8b05d> \u2192 </button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} data-v-37d8b05d>`);
      if (unref(loading)) {
        _push(`<span data-v-37d8b05d>Cargando...</span>`);
      } else {
        _push(`<span data-v-37d8b05d>Actualizar</span>`);
      }
      _push(`</button></div></div>`);
      if (unref(citasConBonoProximoAgotar).length > 0) {
        _push(`<div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6" data-v-37d8b05d><div class="flex" data-v-37d8b05d><div class="flex-shrink-0" data-v-37d8b05d><svg class="h-5 w-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" data-v-37d8b05d><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" data-v-37d8b05d></path></svg></div><div class="ml-3" data-v-37d8b05d><p class="text-sm text-yellow-700" data-v-37d8b05d><strong data-v-37d8b05d>Atenci\xF3n:</strong> ${ssrInterpolate(unref(citasConBonoProximoAgotar).length)} paciente(s) con pocas sesiones restantes </p></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (vista.value === "calendario") {
        _push(`<div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden flex flex-col" style="${ssrRenderStyle({ "height": "calc(100vh - 280px)" })}" data-v-37d8b05d><div class="min-w-[800px] overflow-x-auto flex-1 flex flex-col" data-v-37d8b05d><div class="sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm" data-v-37d8b05d><div class="grid grid-cols-8" data-v-37d8b05d><div class="p-2 border-r border-gray-200 bg-gray-50" data-v-37d8b05d></div><!--[-->`);
        ssrRenderList(diasSemana.value, (dia) => {
          _push(`<div class="${ssrRenderClass([esHoy(dia.fecha) ? "bg-blue-50" : "bg-white", "p-2 text-center border-r border-gray-200 last:border-r-0"])}" data-v-37d8b05d><div class="flex items-center justify-center gap-1" data-v-37d8b05d><span class="text-xs font-medium text-gray-600 uppercase" data-v-37d8b05d>${ssrInterpolate(dia.nombreDia)}</span><span class="${ssrRenderClass([esHoy(dia.fecha) ? "text-blue-600" : "", "text-lg font-bold text-gray-900"])}" data-v-37d8b05d>${ssrInterpolate(dia.numeroDia)}</span></div><div class="text-xs text-gray-500" data-v-37d8b05d>${ssrInterpolate(dia.mes)}</div></div>`);
        });
        _push(`<!--]--></div></div><div class="flex-1 overflow-y-auto" data-v-37d8b05d><div class="divide-y divide-gray-100" data-v-37d8b05d><!--[-->`);
        ssrRenderList(horasDelDia, (hora) => {
          _push(`<div${ssrRenderAttr("data-hora", hora)} class="grid grid-cols-8" data-v-37d8b05d><div class="p-3 text-sm font-medium text-gray-600 border-r border-gray-100 bg-gray-50 sticky left-0" data-v-37d8b05d>${ssrInterpolate(hora)}</div><!--[-->`);
          ssrRenderList(diasSemana.value, (dia) => {
            _push(`<div class="${ssrRenderClass([[
              esHoy(dia.fecha) ? "bg-blue-50/20" : "",
              esCeldaObjetivo(dia.fecha, hora) ? "bg-blue-100 ring-2 ring-blue-500 ring-inset" : ""
            ], "p-2 border-r border-gray-100 last:border-r-0 hover:bg-blue-50/30 transition-colors min-h-[70px] cursor-pointer relative group/cell"])}" data-v-37d8b05d>`);
            if (citasPorDiaHora(dia.fecha, hora).length === 0) {
              _push(`<div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover/cell:opacity-100 transition-opacity pointer-events-none" data-v-37d8b05d><span class="text-xs text-blue-600 font-medium bg-white px-2 py-1 rounded-full shadow-sm" data-v-37d8b05d> Libre </span></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`<!--[-->`);
            ssrRenderList(citasPorDiaHora(dia.fecha, hora), (cita) => {
              var _a;
              _push(`<div draggable="true" class="${ssrRenderClass([getClasesCita(cita.estado), "text-xs p-2 rounded-lg mb-1.5 hover:shadow-lg hover:ring-2 hover:ring-blue-400 transition-all group relative cursor-move"])}" title="Arrastra para mover" data-v-37d8b05d><div class="opacity-0 group-hover:opacity-100 transition-opacity absolute top-1 left-1" data-v-37d8b05d>`);
              _push(ssrRenderComponent(unref(ArrowsPointingOutIcon), { class: "w-3 h-3 text-gray-500" }, null, _parent));
              _push(`</div><div class="pl-5" data-v-37d8b05d><p class="font-semibold truncate text-sm" data-v-37d8b05d>${ssrInterpolate(((_a = cita.paciente) == null ? void 0 : _a.nombre_completo) || "Sin nombre")}</p><p class="text-xs text-gray-600 mt-0.5" data-v-37d8b05d>${ssrInterpolate(formatearHora(cita.hora_inicio))} - ${ssrInterpolate(formatearHora(cita.hora_fin))}</p><div class="flex items-center gap-1 mt-1" data-v-37d8b05d><span class="text-xs px-1.5 py-0.5 rounded-full bg-white/60" data-v-37d8b05d>${ssrInterpolate(cita.modalidad)}</span>`);
              if (cita.bono) {
                _push(`<span class="text-xs text-green-700" data-v-37d8b05d> Bono </span>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div></div></div>`);
        ...
        _push(`<div data-v-37d8b05d><div class="flex flex-wrap gap-2 mb-6" data-v-37d8b05d><!--[-->`);
        ssrRenderList([
          ...
          ])}" data-v-37d8b05d>${ssrInterpolate(filtro.label)} (${ssrInterpolate(filtro.count)}) </button>`);
        });
        _push(`<!--]--></div>`);
        if (unref(error)) {
          _push(`<div class="bg-red-50 border-l-4 border-red-400 p-4 mb-6" data-v-37d8b05d><p class="text-red-700" data-v-37d8b05d>${ssrInterpolate(unref(error))}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(loading) && unref(citas).length === 0) {
          _push(`<div class="text-center py-12" data-v-37d8b05d><div class="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4" data-v-37d8b05d></div><p class="text-gray-600" data-v-37d8b05d>Cargando citas...</p></div>`);
        } else if (citasFiltradas.value.length === 0) {
          _push(`<div class="text-center py-12 bg-gray-50 rounded-lg" data-v-37d8b05d><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-37d8b05d><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-v-37d8b05d></path></svg><h3 class="mt-2 text-sm font-medium text-gray-900" data-v-37d8b05d>No hay citas</h3><p class="mt-1 text-sm text-gray-500" data-v-37d8b05d>${ssrInterpolate(filtroActivo.value === "hoy" ? "No tienes citas programadas para hoy." : "No hay citas en esta categor\xEDa.")}</p></div>`);
        } else {
          _push(`<div class="space-y-4" data-v-37d8b05d><!--[-->`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (mostrarModalHistorial.value) {
          _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" data-v-37d8b05d><div class="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-hidden" data-v-37d8b05d><div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between" data-v-37d8b05d><h2 class="text-xl font-bold text-gray-900" data-v-37d8b05d>Historial del Bono</h2><button class="text-gray-400 hover:text-gray-600 transition-colors" data-v-37d8b05d><svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-37d8b05d><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-37d8b05d></path></svg></button></div><div class="px-6 py-4 overflow-y-auto max-h-[calc(90vh-140px)]" data-v-37d8b05d>`);
          if (cargandoModal.value) {
            _push2(`<div class="text-center py-8" data-v-37d8b05d><div class="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto" data-v-37d8b05d></div></div>`);
          } else {
            _push2(`<div data-v-37d8b05d>`);
            if (verificacionBono.value) {
              _push2(`<div class="mb-6 p-4 bg-blue-50 rounded-lg" data-v-37d8b05d><h3 class="font-semibold text-gray-900 mb-3" data-v-37d8b05d>Resumen</h3><div class="grid grid-cols-3 gap-4 text-center" data-v-37d8b05d><div data-v-37d8b05d><p class="text-2xl font-bold text-blue-600" data-v-37d8b05d>${ssrInterpolate(verificacionBono.value.bono.sesiones_totales)}</p><p class="text-xs text-gray-600" data-v-37d8b05d>Sesiones Totales</p></div><div data-v-37d8b05d><p class="text-2xl font-bold text-green-600" data-v-37d8b05d>${ssrInterpolate(verificacionBono.value.bono.sesiones_usadas)}</p><p class="text-xs text-gray-600" data-v-37d8b05d>Sesiones Usadas</p></div><div data-v-37d8b05d><p class="${ssrRenderClass(["text-2xl font-bold", claseSesionesRestantes(verificacionBono.value.bono.sesiones_restantes)])}" data-v-37d8b05d>${ssrInterpolate(verificacionBono.value.bono.sesiones_restantes)}</p><p class="text-xs text-gray-600" data-v-37d8b05d>Sesiones Restantes</p></div></div>`);
              if (verificacionBono.value.alerta) {
                _push2(`<div class="mt-3 p-2 bg-yellow-100 border border-yellow-300 rounded text-sm text-yellow-800" data-v-37d8b05d>${ssrInterpolate(verificacionBono.value.mensaje_alerta)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            _push2(`<div data-v-37d8b05d><h3 class="font-semibold text-gray-900 mb-3" data-v-37d8b05d>Movimientos</h3>`);
            if (historialBono.value.length === 0) {
              _push2(`<div class="text-center py-8 text-gray-500" data-v-37d8b05d> No hay movimientos registrados </div>`);
            } else {
              _push2(`<div class="space-y-3" data-v-37d8b05d><!--[-->`);
              ssrRenderList(historialBono.value, (mov) => {
                _push2(`<div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors" data-v-37d8b05d><div class="flex items-start justify-between" data-v-37d8b05d><div class="flex-1" data-v-37d8b05d><div class="flex items-center gap-2 mb-1" data-v-37d8b05d><span class="${ssrRenderClass([
                ...
                ])}" data-v-37d8b05d>${ssrInterpolate(mov.tipo_movimiento)}</span><span class="text-xs text-gray-500" data-v-37d8b05d>${ssrInterpolate(new Date(mov.fecha).toLocaleString("es-ES"))}</span></div><p class="text-sm text-gray-700" data-v-37d8b05d>${ssrInterpolate(mov.motivo)}</p></div><div class="text-right ml-4" data-v-37d8b05d><p class="text-sm font-semibold text-gray-900" data-v-37d8b05d>${ssrInterpolate(mov.sesiones_antes)} \u2192 ${ssrInterpolate(mov.sesiones_despues)}</p><p class="${ssrRenderClass([
                  "text-xs font-medium",
                  mov.sesiones_modificadas > 0 ? "text-red-600" : "text-green-600"
                ])}" data-v-37d8b05d>${ssrInterpolate(mov.sesiones_modificadas > 0 ? "-" : "+")}${ssrInterpolate(Math.abs(mov.sesiones_modificadas))}</p></div></div></div>`);
              });
              _push2(`<!--]--></div>`);
            }
            _push2(`</div></div>`);
          }
          _push2(`</div><div class="px-6 py-4 border-t border-gray-200 flex justify-end" data-v-37d8b05d><button class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors" data-v-37d8b05d> Cerrar </button></div></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-37d8b05d"]]), { __name: "AgendaTerapeuta" });

export { __nuxt_component_0 as _, __nuxt_component_1 as a, useAgenda as u };
//# sourceMappingURL=AgendaTerapeuta-DyDyv4yt.mjs.map
