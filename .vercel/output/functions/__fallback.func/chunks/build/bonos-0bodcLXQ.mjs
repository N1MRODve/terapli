    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.bono.fecha_inicio || __props.bono.fecha_fin) {
        ...
        if (unref(diasRestantes) !== null && __props.bono.estado === "activo") {
          _push(`<div class="mt-2 text-xs text-center text-[#5D4A44]/60" data-v-a85fab0a>${ssrInterpolate(unref(diasRestantes) > 0 ? `${unref(diasRestantes)} días restantes` : "Vencido")}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (__props.bono.renovacion_automatica) {
        _push(`<div class="flex items-center gap-2 mb-4 p-2 bg-purple-50 border border-purple-200 rounded-lg" data-v-a85fab0a><span class="text-sm" data-v-a85fab0a>🔄</span><span class="text-xs text-purple-700 font-medium" data-v-a85fab0a>Renovación automática activada</span></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (unref(puedeVerPagos)) {
        _push(`<button class="flex-1 px-4 py-2 bg-[#D8AFA0] text-white rounded-lg hover:bg-[#C89B8A] transition-colors text-sm font-medium flex items-center justify-center gap-2" data-v-a85fab0a><span data-v-a85fab0a>💰</span><span data-v-a85fab0a>Ver Pagos</span></button>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(puedeRenovar) && __props.bono.estado !== "activo") {
        _push(`<button class="flex-1 px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors text-sm font-medium flex items-center justify-center gap-2" data-v-a85fab0a><span data-v-a85fab0a>🔄</span><span data-v-a85fab0a>Renovar</span></button>`);
      } else {
        _push(`<!---->`);
      }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.mostrar) {
        ...
        if (unref(mostrarFormularioPago)) {
          _push(`<div class="p-5 bg-green-50 border-2 border-green-300 rounded-xl" data-v-46056b94><h3 class="font-[&#39;Lora&#39;] text-lg font-semibold text-[#5D4A44] mb-4 flex items-center gap-2" data-v-46056b94><span data-v-46056b94>💳</span> Registrar Nuevo Pago </h3><form class="space-y-4" data-v-46056b94><div class="grid grid-cols-2 gap-4" data-v-46056b94><div data-v-46056b94><label class="block text-sm font-medium text-[#5D4A44] mb-2" data-v-46056b94> Monto <span class="text-red-500" data-v-46056b94>*</span></label><div class="relative" data-v-46056b94><span class="absolute left-3 top-1/2 -translate-y-1/2 text-[#5D4A44]/60" data-v-46056b94>€</span><input${ssrRenderAttr("value", unref(nuevoPago).monto)} type="number" min="0" step="0.01" required placeholder="0.00" class="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D8AFA0] bg-white" data-v-46056b94></div></div><div data-v-46056b94><label class="block text-sm font-medium text-[#5D4A44] mb-2" data-v-46056b94> Método de Pago <span class="text-red-500" data-v-46056b94>*</span></label><select required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D8AFA0] bg-white" data-v-46056b94><option value="" data-v-46056b94${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "") : ssrLooseEqual(unref(nuevoPago).metodo, "")) ? " selected" : ""}>Seleccionar método</option><option value="efectivo" data-v-46056b94${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "efectivo") : ssrLooseEqual(unref(nuevoPago).metodo, "efectivo")) ? " selected" : ""}>💵 Efectivo</option><option value="transferencia" data-v-46056b94${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "transferencia") : ssrLooseEqual(unref(nuevoPago).metodo, "transferencia")) ? " selected" : ""}>🏦 Transferencia</option><option value="tarjeta" data-v-46056b94${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "tarjeta") : ssrLooseEqual(unref(nuevoPago).metodo, "tarjeta")) ? " selected" : ""}>💳 Tarjeta</option><option value="bizum" data-v-46056b94${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "bizum") : ssrLooseEqual(unref(nuevoPago).metodo, "bizum")) ? " selected" : ""}>📱 Bizum</option><option value="paypal" data-v-46056b94${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "paypal") : ssrLooseEqual(unref(nuevoPago).metodo, "paypal")) ? " selected" : ""}>🅿️ PayPal</option></select></div></div>`);
        ...
        _push(`<div data-v-46056b94><h3 class="font-[&#39;Lora&#39;] text-lg font-semibold text-[#5D4A44] mb-4 flex items-center gap-2" data-v-46056b94><span data-v-46056b94>📜</span> Historial de Pagos (${ssrInterpolate(unref(pagos).length)}) </h3>`);
        if (unref(cargando)) {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.mostrar) {
        ...
        _push(`<span>${ssrInterpolate(unref(renovando) ? "Renovando..." : "Confirmar Renovación")}</span></button></div></form></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
  ...
  setup(__props) {
    ...
    const cargarBonos = async () => {
      try {
        ...
        pacienteNombre.value = paciente?.nombre || paciente?.email || "Paciente";
      ...
      if (unref(cargando)) {
                ...
                createVNode("div", { class: "flex flex-col md:flex-row gap-4" }, [
                  createVNode("div", { class: "flex-1" }, [
                    ...
                    withDirectives(createVNode("select", {
                      ...
                      createVNode("option", { value: "cancelado" }, "🚫 Cancelados")
                  ...
                  createVNode("div", { class: "flex-1" }, [
                    ...
                    withDirectives(createVNode("select", {
                      ...
                      createVNode("option", { value: "reciente" }, "Más recientes"),
                      createVNode("option", { value: "antiguo" }, "Más antiguos"),
        ...
        if (unref(bonosFiltrados).length > 0) {
          ...
          _push(ssrRenderComponent(_component_DashboardCard, null, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="text-7xl mb-4 block opacity-40" data-v-64cfe15d${_scopeId}>🎫</span><h3 class="text-xl font-[&#39;Lora&#39;] font-semibold text-[#5D4A44] mb-2" data-v-64cfe15d${_scopeId}>${ssrInterpolate(unref(bonos2).length === 0 ? "No hay bonos registrados" : "No hay bonos con estos filtros")}</h3><p class="text-[#5D4A44]/60 mb-6" data-v-64cfe15d${_scopeId}>${ssrInterpolate(unref(bonos2).length === 0 ? "Crea el primer bono para este paciente" : "Intenta cambiar los filtros para ver más bonos")}</p>`);
                ...
                return [
                  createVNode("span", { class: "text-7xl mb-4 block opacity-40" }, "🎫"),
                  ...
                  createVNode("p", { class: "text-[#5D4A44]/60 mb-6" }, toDisplayString(unref(bonos2).length === 0 ? "Crea el primer bono para este paciente" : "Intenta cambiar los filtros para ver más bonos"), 1),
