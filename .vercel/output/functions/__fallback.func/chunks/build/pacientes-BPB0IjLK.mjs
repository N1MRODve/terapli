...
import { _ as __nuxt_component_2$1 } from './ModalNuevaCita-6Mm-k6WH.mjs';
import { u as useSupabase } from './useSupabase-DljD0dj8.mjs';
import { u as useBonos } from './useBonos-BFarM2bD.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(areaAcompanamiento)) {
        _push(`<div class="mb-4 flex items-center gap-2" data-v-e4c2174f><span class="text-xs text-gray-400 uppercase tracking-wide" data-v-e4c2174f>Área:</span><span class="text-sm text-gray-700 font-medium" data-v-e4c2174f>${ssrInterpolate(unref(areaAcompanamiento))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`<span data-v-e4c2174f>Última sesión: </span><span class="font-medium" data-v-e4c2174f>${ssrInterpolate(unref(ultimaSesion))}</span></div><div class="flex items-center gap-2 text-sm text-gray-600" data-v-e4c2174f>`);
      _push(ssrRenderComponent(unref(ClockIcon), { class: "w-4 h-4 text-terracota flex-shrink-0" }, null, _parent));
      _push(`<span data-v-e4c2174f>Próxima: </span>`);
      ...
      if (unref(tieneAlertaBonoCritica)) {
        ...
        _push(`<div class="flex-1" data-v-e4c2174f><p class="text-xs font-semibold text-red-800 mb-1" data-v-e4c2174f> Bono casi agotado </p><p class="text-xs text-red-700" data-v-e4c2174f> Solo queda ${ssrInterpolate(unref(bonoActivo).sesiones_restantes)} sesión. Informar para renovación. </p></div></div>`);
        ...
        _push(`<div class="flex-1" data-v-e4c2174f><p class="text-xs font-semibold text-amber-800 mb-1" data-v-e4c2174f> Bono próximo a agotar </p><p class="text-xs text-amber-700" data-v-e4c2174f> Quedan ${ssrInterpolate(unref(bonoActivo).sesiones_restantes)} sesiones. Considerar renovación. </p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(tieneAlertaInactividad)) {
        ...
        _push(`<div class="flex-1" data-v-e4c2174f><p class="text-xs font-semibold text-red-800 mb-1" data-v-e4c2174f> Riesgo de abandono </p><p class="text-xs text-red-700" data-v-e4c2174f>${ssrInterpolate(unref(diasInactividad))} días sin sesión. Considera contactar pronto. </p></div></div>`);
      } else {
        _push(`<!---->`);
      }
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.mostrar) {
        ...
        _push(`<!--]--></div><p class="text-xs text-cafe/60 mt-1"> 💡 Puedes escribir la fecha/hora o usar el selector </p></div></div></div><div class="space-y-4 pt-4 border-t border-[#D8AFA0]/30"><div class="border-t pt-6"><h3 class="text-lg font-[&#39;Lora&#39;] text-[#5D4A44] font-semibold mb-2"> 💳 Bono Inicial (Opcional) </h3>`);
        if (unref(esADemanda)) {
          _push(`<div class="bg-amber-50 border-2 border-amber-200 rounded-lg p-4 mb-3"><div class="flex items-start gap-3"><span class="text-2xl">ℹ️</span><div><p class="text-sm font-semibold text-amber-900 mb-1"> Sesión &quot;A Demanda&quot; seleccionada </p><p class="text-sm text-amber-800"> Las sesiones a demanda son <strong>sin compromiso</strong> y se pagan individualmente (60€ por sesión). No es necesario crear un bono prepagado. </p></div></div></div>`);
        } else {
          _push(`<p class="text-sm text-cafe/70 mb-3"> Crea un bono prepagado para que el paciente empiece su tratamiento. Podrás confirmar el pago después. </p>`);
        }
        _push(`<label class="${ssrRenderClass([unref(esADemanda) ? "bg-gray-100 border-2 border-gray-200 cursor-not-allowed opacity-60" : "bg-purple-50 border-2 border-purple-200 cursor-pointer hover:bg-purple-100", "flex items-center gap-3 p-3 rounded-lg transition-colors"])}"><input${ssrIncludeBooleanAttr(Array.isArray(formulario.value.crear_bono) ? ssrLooseContain(formulario.value.crear_bono, null) : formulario.value.crear_bono) ? " checked" : ""} type="checkbox"${ssrIncludeBooleanAttr(unref(esADemanda)) ? " disabled" : ""} class="w-5 h-5 text-purple-600 border-gray-300 rounded focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed"><span class="${ssrRenderClass([unref(esADemanda) ? "text-gray-500" : "text-purple-700", "text-sm font-semibold"])}"> ✅ Sí, crear bono prepagado para este paciente </span></label></div>`);
        if (formulario.value.crear_bono) {
          _push(`<div class="border-2 border-purple-400/40 rounded-lg p-5 space-y-4 bg-gradient-to-br from-purple-50 to-purple-100/50"><div class="bg-white border-2 border-purple-300 rounded-lg p-4 shadow-sm"><div class="flex items-start gap-3"><div class="w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0"><span class="text-white text-xl">🎟️</span></div><div class="flex-1"><h4 class="font-semibold text-purple-900 mb-1"> Tipo de Bono: ${ssrInterpolate(unref(nombreTipoBono) || "Selecciona un tipo arriba")}</h4><div class="grid grid-cols-2 gap-3 text-sm"><div class="flex items-center gap-2"><span class="text-purple-600">📊</span><span class="text-purple-800"><strong>${ssrInterpolate(unref(sesionesSegunTipo))}</strong> ${ssrInterpolate(unref(sesionesSegunTipo) === 1 ? "sesión" : "sesiones")}</span></div>`);
          if (unref(precioSugeridoBono) > 0) {
            _push(`<div class="flex items-center gap-2"><span class="text-purple-600">💰</span><span class="text-purple-800"> Precio sugerido: <strong>€${ssrInterpolate(unref(precioSugeridoBono))}</strong></span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><p class="text-xs text-purple-600 mt-2 bg-purple-50 p-2 rounded"> 💡 <strong>Tip:</strong> Los precios se calcularán automáticamente según el tipo de bono </p></div></div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div><label for="bono_monto" class="block text-sm font-medium text-[#5D4A44] mb-1"> Monto Total <span class="text-red-500">*</span></label><div class="relative"><span class="absolute left-3 top-1/2 -translate-y-1/2 text-[#5D4A44]/60">€</span><input id="bono_monto"${ssrRenderAttr("value", formulario.value.bono_monto)} type="number" min="0" step="0.01"${ssrIncludeBooleanAttr(formulario.value.crear_bono) ? " required" : ""} placeholder="0.00" class="w-full pl-8 pr-4 py-2 border border-purple-300 rounded-lg focus:ring-2 focus:ring-purple-500 bg-white"></div></div><div><label class="block text-sm font-medium text-[#5D4A44] mb-1"> Precio por Sesión </label><div class="px-4 py-2 bg-purple-100 rounded-lg border border-purple-300"><span class="text-lg font-bold text-purple-700">€${ssrInterpolate(unref(precioPorSesionBono))}</span></div></div><div class="md:col-span-2"><label class="flex items-start gap-3 p-4 bg-white border-2 border-purple-200 rounded-lg cursor-pointer hover:bg-purple-50 hover:border-purple-300 transition-all"><input${ssrIncludeBooleanAttr(Array.isArray(formulario.value.bono_renovacion_automatica) ? ssrLooseContain(formulario.value.bono_renovacion_automatica, null) : formulario.value.bono_renovacion_automatica) ? " checked" : ""} type="checkbox" class="mt-1 w-5 h-5 text-purple-600 border-gray-300 rounded focus:ring-purple-500"><div class="flex-1"><div class="flex items-center gap-2 mb-1"><span class="text-lg">🔄</span><span class="text-sm font-semibold text-purple-900"> Renovación Automática </span><span class="ml-auto px-2 py-0.5 bg-purple-100 text-purple-700 text-xs font-medium rounded"> Recomendado </span></div><div class="text-xs text-[#5D4A44]/70 space-y-1"><p>✓ El bono se renovará automáticamente cuando se agoten las sesiones o expire</p><p>✓ Mantiene la continuidad del tratamiento sin interrupciones</p><p>✓ Puedes desactivar la renovación en cualquier momento</p></div></div></label></div></div>`);
          if (unref(sesionesSegunTipo) > 0 && formulario.value.bono_monto > 0) {
            _push(`<div class="p-3 bg-white rounded-lg border border-purple-300"><div class="text-xs font-medium text-purple-800 mb-2">📋 Resumen del Bono</div><div class="grid grid-cols-3 gap-2 text-xs"><div><span class="text-[#5D4A44]/60">Tipo:</span><span class="font-medium text-[#5D4A44] ml-1">${ssrInterpolate(unref(nombreTipoBono))}</span></div><div><span class="text-[#5D4A44]/60">Sesiones:</span><span class="font-medium text-[#5D4A44] ml-1">${ssrInterpolate(unref(sesionesSegunTipo))}</span></div><div><span class="text-[#5D4A44]/60">Total:</span><span class="font-medium text-[#5D4A44] ml-1">€${ssrInterpolate(formulario.value.bono_monto)}</span></div></div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.mostrar) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" }, _attrs))} data-v-650451a2><div class="bg-[#F9F7F3] rounded-lg shadow-xl max-w-md w-full" data-v-650451a2><div class="px-6 py-4 border-b border-[#D8AFA0]/30" data-v-650451a2><div class="flex items-center gap-3" data-v-650451a2><span class="text-3xl" data-v-650451a2>⚠️</span><h2 class="text-2xl font-[&#39;Lora&#39;] text-[#5D4A44] font-semibold" data-v-650451a2> Eliminar Paciente </h2></div></div><div class="px-6 py-6 space-y-4" data-v-650451a2><p class="text-[#5D4A44]" data-v-650451a2> ¿Estás seguro de que deseas eliminar a <strong class="font-semibold" data-v-650451a2>${ssrInterpolate(pacienteNombre.value)}</strong>? </p><div class="bg-red-50 border border-red-200 rounded-lg p-4 space-y-2" data-v-650451a2><p class="text-sm text-red-800 font-medium" data-v-650451a2> Esta acción no se puede deshacer y eliminará: </p><ul class="text-sm text-red-700 space-y-1 ml-4 list-disc" data-v-650451a2><li data-v-650451a2>Todos los datos personales del paciente</li><li data-v-650451a2>El historial de sesiones</li><li data-v-650451a2>Las notas terapéuticas</li><li data-v-650451a2>Las métricas de bienestar</li><li data-v-650451a2>Los bonos asociados</li></ul></div><div class="bg-blue-50 border border-blue-200 rounded-lg p-4" data-v-650451a2><p class="text-sm text-blue-800 font-medium mb-2" data-v-650451a2> 💡 Recomendación: </p><p class="text-sm text-blue-700 mb-3" data-v-650451a2> En lugar de eliminar, considera <strong data-v-650451a2>desactivar</strong> al paciente. Esto preservará el historial para consultas futuras. </p><button type="button"${ssrIncludeBooleanAttr(procesando.value) ? " disabled" : ""} class="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm" data-v-650451a2> Desactivar en lugar de eliminar </button></div>`);
        if (error.value) {
  ...
  setup(__props) {
      ...
      `).eq("terapeuta_id", userId).order("created_at", { ascending: false });
        ...
        const pacientesEnriquecidos = await Promise.all(
          pacientesData.map(async (paciente) => {
            ...
            const nombreCompleto = paciente.nombre_completo || paciente.metadata?.nombre_completo || paciente.email;
            return {
              id: paciente.id,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<h3 class="text-xl font-serif font-semibold text-cafe mb-3" data-v-da126003>${ssrInterpolate(unref(busqueda) || unref(estadoSeleccionado) !== "todos" ? "No se encontraron pacientes" : "Aún no tienes pacientes registrados")}</h3><p class="text-gray-500 mb-6 max-w-md mx-auto" data-v-da126003>${ssrInterpolate(unref(busqueda) || unref(estadoSeleccionado) !== "todos" ? "Intenta ajustar los filtros de búsqueda para encontrar lo que buscas" : "Comienza añadiendo tu primer paciente para gestionar su proceso terapéutico")}</p>`);
        if (!unref(busqueda) && unref(estadoSeleccionado) === "todos") {
          _push(`<button class="px-6 py-3 bg-terracota text-white rounded-lg hover:bg-terracota/90 transition-all font-medium shadow-sm hover:shadow-md" data-v-da126003> + Añadir Primer Paciente </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (unref(pacientesFiltrados).length > 0) {
        ...
        if (unref(totalPacientes) > unref(pacientesFiltrados).length) {
          _push(`<div class="flex gap-2" data-v-da126003><button class="px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium" data-v-da126003> Ver más </button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</footer>`);
...
//# sourceMappingURL=pacientes-BPB0IjLK.mjs.map
