    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.isOpen && __props.cita) {
          ...
          ])}">${ssrInterpolate(puedeReintegrar.value ? "✓ Cancelación con anticipación" : "⚠️ Cancelación sin anticipación suficiente")}</p><p class="${ssrRenderClass([
            "text-xs",
