      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="font-medium" data-v-5f877428${_scopeId}>Mensajería</span>`);
          } else {
            return [
              createVNode(unref(EnvelopeIcon), { class: "w-5 h-5" }),
              createVNode("span", { class: "font-medium" }, "Mensajería")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="font-medium" data-v-5f877428${_scopeId}>Configuración</span>`);
          } else {
            return [
              createVNode(unref(Cog6ToothIcon), { class: "w-5 h-5" }),
              createVNode("span", { class: "font-medium" }, "Configuración")
            ];
          }
        }),
        _: 1
