...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-gradient-to-br from-white to-cafe/5 rounded-2xl p-6 md:p-8 shadow-lg border border-cafe/10 space-y-6 transition-all duration-300" }, _attrs))} data-v-be9820b5><div class="border-b border-cafe/10 pb-5" data-v-be9820b5><div class="flex items-center gap-3 mb-2" data-v-be9820b5><div class="w-10 h-10 rounded-xl bg-gradient-to-br from-terracota/20 to-terracota/10 flex items-center justify-center" data-v-be9820b5><span class="text-xl" data-v-be9820b5>🎫</span></div><h3 class="font-serif text-2xl font-bold text-cafe" data-v-be9820b5>Bonos del Paciente</h3></div><p class="text-sm text-cafe/60 ml-13" data-v-be9820b5>Gestión y seguimiento de sesiones contratadas</p></div>`);
      if (loading.value) {
        _push(`<div class="text-center py-16" data-v-be9820b5><div class="relative inline-block" data-v-be9820b5><div class="w-12 h-12 border-4 border-terracota/20 border-t-terracota rounded-full animate-spin" data-v-be9820b5></div><div class="absolute inset-0 w-12 h-12 border-4 border-transparent border-b-cafe/20 rounded-full animate-spin" style="${ssrRenderStyle({ "animation-duration": "1.5s", "animation-direction": "reverse" })}" data-v-be9820b5></div></div><p class="mt-4 text-sm text-cafe/60 font-medium" data-v-be9820b5>Cargando información de bonos...</p></div>`);
        ...
        ssrRenderList(bonosActivos.value, (bono) => {
          _push(`<div class="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-cafe/10 overflow-hidden" data-v-be9820b5><div class="bg-gradient-to-r from-terracota/5 via-white to-terracota/5 px-6 py-4 border-b border-cafe/5" data-v-be9820b5><div class="flex items-start justify-between gap-4" data-v-be9820b5><div class="flex-1" data-v-be9820b5><div class="flex items-center gap-3 mb-2" data-v-be9820b5><div class="w-10 h-10 rounded-xl bg-gradient-to-br from-terracota to-terracota/80 flex items-center justify-center shadow-sm" data-v-be9820b5><span class="text-white text-lg" data-v-be9820b5>🎟️</span></div><div data-v-be9820b5><h5 class="text-base font-bold text-cafe" data-v-be9820b5>${ssrInterpolate(getBonoCantidadSesiones(bono))}</h5><p class="text-xs text-cafe/60 flex items-center gap-1.5" data-v-be9820b5><span data-v-be9820b5>📅</span><span data-v-be9820b5>Creado ${ssrInterpolate(formatearFecha(bono.created_at))}</span></p></div></div></div><div class="flex flex-col items-end gap-2" data-v-be9820b5><span class="${ssrRenderClass([getEstadoBadgeClasses(bono), "px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide shadow-sm backdrop-blur-sm transition-all duration-200"])}" data-v-be9820b5>${ssrInterpolate(getEstadoLabel(bono))}</span>`);
          if (!bono.pagado) {
            _push(`<span class="px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide shadow-sm bg-gradient-to-r from-yellow-100 to-orange-100 text-orange-700 border border-orange-200 animate-pulse" title="Pendiente de confirmación de pago" data-v-be9820b5> 💳 Sin pagar </span>`);
          } else {
    ...
    const pacientesFiltrados = computed(() => {
      ...
      if (busqueda.value.trim()) {
        ...
        resultado = resultado.filter(
          (p) => p.nombre_completo?.toLowerCase().includes(query) || p.email?.toLowerCase().includes(query) || p.telefono?.includes(query) || p.terapeuta_nombre?.toLowerCase().includes(query)
        );
      }
...
El bono ahora está marcado como "NO PAGADO"`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></select><select class="px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-terracota/20 transition-all duration-200" data-v-ef92321c><option value="nombre" data-v-ef92321c${ssrIncludeBooleanAttr(Array.isArray(unref(ordenarPor)) ? ssrLooseContain(unref(ordenarPor), "nombre") : ssrLooseEqual(unref(ordenarPor), "nombre")) ? " selected" : ""}>Ordenar por nombre</option><option value="fecha" data-v-ef92321c${ssrIncludeBooleanAttr(Array.isArray(unref(ordenarPor)) ? ssrLooseContain(unref(ordenarPor), "fecha") : ssrLooseEqual(unref(ordenarPor), "fecha")) ? " selected" : ""}>Fecha última sesión</option><option value="citas" data-v-ef92321c${ssrIncludeBooleanAttr(Array.isArray(unref(ordenarPor)) ? ssrLooseContain(unref(ordenarPor), "citas") : ssrLooseEqual(unref(ordenarPor), "citas")) ? " selected" : ""}>Más citas</option></select></div></div><div class="grid grid-cols-2 md:grid-cols-4 gap-4" data-v-ef92321c><div class="bg-terracota/5 rounded-xl p-4 border border-terracota/10 transition-all duration-300 hover:shadow-md" data-v-ef92321c><div class="flex items-center gap-3" data-v-ef92321c><div class="text-3xl" data-v-ef92321c>👥</div><div class="flex-1" data-v-ef92321c><div class="text-2xl font-bold text-cafe" data-v-ef92321c>${ssrInterpolate(unref(totalPacientes))}</div><div class="text-sm text-cafe/60" data-v-ef92321c>Total pacientes</div></div></div></div><div class="bg-green-50 rounded-xl p-4 border border-green-100 transition-all duration-300 hover:shadow-md" data-v-ef92321c><div class="flex items-center gap-3" data-v-ef92321c><div class="text-3xl" data-v-ef92321c>🟢</div><div class="flex-1" data-v-ef92321c><div class="text-2xl font-bold text-green-700" data-v-ef92321c>${ssrInterpolate(unref(pacientesActivos))}</div><div class="text-sm text-green-600/80" data-v-ef92321c>Activos</div></div></div></div><div class="bg-blue-50 rounded-xl p-4 border border-blue-100 transition-all duration-300 hover:shadow-md" data-v-ef92321c><div class="flex items-center gap-3" data-v-ef92321c><div class="text-3xl" data-v-ef92321c>🧑‍⚕️</div><div class="flex-1" data-v-ef92321c><div class="text-2xl font-bold text-blue-700" data-v-ef92321c>${ssrInterpolate(unref(promedioPorTerapeuta))}</div><div class="text-sm text-blue-600/80" data-v-ef92321c>Prom. por terapeuta</div></div></div></div><div class="bg-purple-50 rounded-xl p-4 border border-purple-100 transition-all duration-300 hover:shadow-md" data-v-ef92321c><div class="flex items-center gap-3" data-v-ef92321c><div class="text-3xl" data-v-ef92321c>💳</div><div class="flex-1" data-v-ef92321c><div class="text-2xl font-bold text-purple-700" data-v-ef92321c>${ssrInterpolate(unref(bonosActivos))}</div><div class="text-sm text-purple-600/80" data-v-ef92321c>Bonos activos</div></div></div></div></div>`);
      if (unref(cargando)) {
        ...
        ssrRenderList(unref(pacientesFiltrados), (paciente) => {
          ...
          if (paciente.telefono) {
            _push(`<p class="text-sm text-gray-500 mt-1" data-v-ef92321c> 📱 ${ssrInterpolate(paciente.telefono)}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
          if (paciente.terapeuta_nombre) {
            _push(`<div class="mb-3 flex items-center gap-2 text-sm bg-cafe/5 px-3 py-2 rounded-lg" data-v-ef92321c><span class="text-cafe/60" data-v-ef92321c>🧑‍⚕️</span><span class="text-cafe font-medium" data-v-ef92321c>${ssrInterpolate(paciente.terapeuta_nombre)}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="space-y-2 mb-4" data-v-ef92321c>`);
          if (paciente.area_de_acompanamiento) {
            _push(`<div class="flex items-center gap-2 text-sm" data-v-ef92321c><span class="text-gray-400" data-v-ef92321c>🎯</span><span class="text-gray-700 truncate" data-v-ef92321c>${ssrInterpolate(paciente.area_de_acompanamiento)}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="flex items-center gap-2 text-sm" data-v-ef92321c><span class="text-gray-400" data-v-ef92321c>📅</span><span class="text-gray-700" data-v-ef92321c>${ssrInterpolate(paciente.total_citas || 0)} sesiones</span></div>`);
          if (paciente.ultima_cita) {
            _push(`<div class="flex items-center gap-2 text-sm" data-v-ef92321c><span class="text-gray-400" data-v-ef92321c>🕐</span><span class="text-gray-700" data-v-ef92321c>Última: ${ssrInterpolate(formatearFecha(paciente.ultima_cita))}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          if (paciente.proxima_cita) {
            _push(`<div class="flex items-center gap-2 text-sm" data-v-ef92321c><span class="text-gray-400" data-v-ef92321c>📆</span><span class="text-gray-700" data-v-ef92321c>Próxima: ${ssrInterpolate(formatearFecha(paciente.proxima_cita))}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><div class="flex items-center justify-between pt-4 border-t border-gray-100" data-v-ef92321c><span class="${ssrRenderClass([getEstadoClasses(paciente.estado), "px-3 py-1 rounded-full text-xs font-medium transition-all duration-200"])}" data-v-ef92321c>${ssrInterpolate(getEstadoLabel(paciente.estado))}</span><div class="flex gap-2" data-v-ef92321c><button class="p-2 text-terracota hover:bg-terracota/10 rounded-lg transition-all duration-200" title="Ver agenda" data-v-ef92321c> � </button><button class="p-2 text-green-600 hover:bg-green-50 rounded-lg transition-all duration-200" title="Abrir WhatsApp" data-v-ef92321c> 💬 </button><button class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200" title="Ver detalles" data-v-ef92321c> 👁️ </button></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      ...
      if (unref(panelAbierto) && unref(pacienteSeleccionado)) {
        ...
        if (unref(pacienteSeleccionado).terapeuta_nombre) {
          _push(`<span class="text-sm text-cafe/70" data-v-ef92321c> 🧑‍⚕️ ${ssrInterpolate(unref(pacienteSeleccionado).terapeuta_nombre)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div><button class="text-cafe/40 hover:text-cafe transition-all duration-200 text-2xl leading-none w-10 h-10 rounded-full flex items-center justify-center hover:bg-cafe/5 hover:rotate-90" aria-label="Cerrar panel" data-v-ef92321c> ✕ </button></div></div><div class="p-8 md:p-10 space-y-8" data-v-ef92321c><section class="bg-white border border-cafe/10 rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1" data-v-ef92321c><h3 class="font-serif font-semibold text-cafe text-lg mb-4 flex items-center gap-2" data-v-ef92321c><span class="text-xl" data-v-ef92321c>📞</span><span data-v-ef92321c>Información de Contacto</span></h3><div class="space-y-3" data-v-ef92321c><div class="flex items-center gap-3 text-cafe/80" data-v-ef92321c><span class="w-6 text-lg" data-v-ef92321c>✉️</span><span class="text-sm" data-v-ef92321c>${ssrInterpolate(unref(pacienteSeleccionado).email)}</span></div>`);
        if (unref(pacienteSeleccionado).telefono) {
          _push(`<div class="flex items-center gap-3 text-cafe/80" data-v-ef92321c><span class="w-6 text-lg" data-v-ef92321c>📱</span><span class="text-sm" data-v-ef92321c>${ssrInterpolate(unref(pacienteSeleccionado).telefono)}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></section>`);
        if (unref(pacienteSeleccionado).area_de_acompanamiento) {
          _push(`<section class="bg-blue-50/50 rounded-xl p-4 border border-blue-100 transition-all duration-300 hover:shadow-md" data-v-ef92321c><h3 class="font-serif font-semibold text-cafe text-lg mb-3 flex items-center gap-2" data-v-ef92321c><span class="text-xl" data-v-ef92321c>🎯</span><span data-v-ef92321c>Área de Acompañamiento</span></h3><p class="text-cafe text-sm leading-relaxed" data-v-ef92321c>${ssrInterpolate(unref(pacienteSeleccionado).area_de_acompanamiento)}</p></section>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<section class="bg-green-50/50 rounded-xl p-5 border border-green-100 transition-all duration-300 hover:shadow-md" data-v-ef92321c><h3 class="font-serif font-semibold text-cafe text-lg mb-4 flex items-center gap-2" data-v-ef92321c><span class="text-xl" data-v-ef92321c>�</span><span data-v-ef92321c>Estadísticas</span></h3><div class="space-y-4" data-v-ef92321c><div class="flex items-center justify-between" data-v-ef92321c><span class="text-sm text-cafe/70" data-v-ef92321c>Total de sesiones</span><span class="text-3xl font-bold text-cafe" data-v-ef92321c>${ssrInterpolate(unref(pacienteSeleccionado).total_citas || 0)}</span></div><div class="flex items-center justify-between" data-v-ef92321c><span class="text-sm text-cafe/70" data-v-ef92321c>Completadas</span><span class="text-lg font-semibold text-green-700" data-v-ef92321c>${ssrInterpolate(unref(pacienteSeleccionado).sesiones_completadas || 0)}</span></div>`);
        if (unref(pacienteSeleccionado).proxima_cita) {
          _push(`<div class="flex items-center gap-2 pt-2 border-t border-green-200" data-v-ef92321c><span class="text-lg" data-v-ef92321c>📅</span><div data-v-ef92321c><p class="text-xs text-cafe/60 uppercase tracking-wide" data-v-ef92321c>Próxima sesión</p><p class="text-sm font-medium text-cafe" data-v-ef92321c>${ssrInterpolate(formatearFecha(unref(pacienteSeleccionado).proxima_cita))}</p></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></section>`);
        ...
        _push(`<section class="bg-white border border-cafe/10 rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-300" data-v-ef92321c><h3 class="font-serif font-semibold text-cafe text-lg mb-5 flex items-center gap-2" data-v-ef92321c><span class="text-xl" data-v-ef92321c>🕓</span><span data-v-ef92321c>Historial de Sesiones</span></h3>`);
        if (unref(pacienteSeleccionado).ultimas_sesiones?.length) {
          ...
          _push(`<div class="text-center py-8" data-v-ef92321c><span class="text-4xl block mb-3 opacity-50" data-v-ef92321c>📅</span><p class="text-sm text-cafe/60" data-v-ef92321c>No hay sesiones registradas aún</p></div>`);
        }
        _push(`</section>`);
...
//# sourceMappingURL=pacientes-old-qq4FLqx6.mjs.map
