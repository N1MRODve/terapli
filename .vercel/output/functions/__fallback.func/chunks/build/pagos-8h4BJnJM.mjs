import { g as useSupabaseClient, h as useSupabaseUser, e as useSupabase, _ as __nuxt_component_0 } from './server.mjs';
            ...
            return [
              createVNode("div", { class: "mb-8 flex items-center justify-between" }, [
                createVNode("div", null, [
                  createVNode("h1", { class: "text-3xl font-lora font-bold text-[#5D4A44] mb-2" }, " Gesti\xF3n de Pagos "),
                  createVNode("p", { class: "text-[#8B7470]" }, " Registro y confirmaci\xF3n de pagos de sesiones ")
                ]),
                createVNode("button", {
                  ...
                  createVNode("span", null, "Registrar pago")
                ], 8, ["onClick"])
              ]),
              createVNode("div", { class: "bg-white rounded-xl shadow-md border border-[#E8DFD8] p-6 mb-6" }, [
                createVNode("div", { class: "grid grid-cols-1 md:grid-cols-4 gap-4" }, [
                  createVNode("div", null, [
                    createVNode("label", { class: "block text-sm font-medium text-[#5D4A44] mb-2" }, "Estado"),
                  ...
                  createVNode("div", null, [
                    createVNode("label", { class: "block text-sm font-medium text-[#5D4A44] mb-2" }, "B\xFAsqueda"),
                        ...
                        return openBlock(), createBlock("tr", {
                          ...
                          createVNode("td", { class: "px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2" }, [
                            pago.estado === "pendiente" ? (openBlock(), createBlock("button", {
                              key: 0,
                              onClick: ($event) => _ctx.confirmarPagoPaciente(pago),
...
//# sourceMappingURL=pagos-8h4BJnJM.mjs.map
