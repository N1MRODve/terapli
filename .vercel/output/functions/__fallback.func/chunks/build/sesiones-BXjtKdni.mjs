  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.sesion.nota_terapeuta && __props.sesion.estado === "realizada") {
        _push(`<div class="bg-[#F9F7F3] rounded-lg p-4 space-y-2 border border-[#EAD5D3]/50"><p class="text-xs font-[&#39;Lato&#39;] font-semibold text-[#D8AFA0] flex items-center space-x-1.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg><span>Notas de la sesión</span></p><p class="${ssrRenderClass([
        ...
        if (__props.sesion.nota_terapeuta.length > 120) {
          _push(`<button class="text-xs font-[&#39;Lato&#39;] font-medium text-[#D8AFA0] hover:text-[#c99d8d] transition-colors">${ssrInterpolate(unref(notaExpandida) ? "Ver menos" : "Ver más")}</button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const _sfc_main$1 = {
  ...
  props: {
    ...
    description: {
      type: String,
      default: "Parece que aún no hay información para mostrar aquí."
    }
  },
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<div class="max-w-4xl mx-auto px-4 py-8 space-y-8"><div class="space-y-4"><div><h1 class="text-3xl font-[&#39;Lora&#39;] font-medium text-[#5D4A44]"> Mis Sesiones </h1><p class="text-sm text-[#5D4A44]/70 font-[&#39;Lato&#39;] mt-2"> Tu espacio de acompañamiento terapéutico </p></div><div class="flex items-center space-x-1 bg-[#F9F7F3] p-1 rounded-xl w-fit"><!--[-->`);
        ...
        if (unref(sesionesProximasRestantes).length > 0 && (unref(filtroActivo) === "todas" || unref(filtroActivo) === "proximas")) {
          _push(`<div class="space-y-3"><h3 class="text-lg font-[&#39;Lora&#39;] font-medium text-[#5D4A44] flex items-center space-x-2"><svg class="w-5 h-5 text-[#D8AFA0]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg><span>Próximas sesiones</span></h3><div class="space-y-3"><!--[-->`);
