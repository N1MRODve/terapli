...
import { u as useNotificaciones } from './useNotificaciones-CrhSSwYp.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (cargando.value) {
        ...
        ssrRenderList(notificacionesFiltradas.value, (notif) => {
          ...
          if (notif.tipo === "bono" && notif.metadata?.sesiones_restantes !== void 0) {
...
//# sourceMappingURL=notificaciones-BmTzPzv5.mjs.map
