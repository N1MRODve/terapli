...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderVNode } from 'vue/server-renderer';
...
const _imports_0 = publicAssetsURL("/images/Karem-Logo-purpu.png");
const _sfc_main$5 = {
  __name: "Header",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "fixed top-0 left-0 right-0 z-50 bg-[#F9F7F3] shadow-sm transition-all duration-300" }, _attrs))} data-v-904d8f19><nav class="flex items-center justify-between w-full h-20 px-6 md:px-10 max-w-[1600px] mx-auto" data-v-904d8f19>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Karem Pe\xF1a" class="h-8 md:h-9" data-v-904d8f19${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<div class="hidden md:flex items-center justify-center gap-6 lg:gap-8 font-[&#39;Lato&#39;] text-base text-[#5D4A44]" data-v-904d8f19>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "nav-link"
      }, {
      ...
      _push(`</div><div class="hidden md:flex items-center gap-4" data-v-904d8f19>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/login",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-904d8f19${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-v-904d8f19${_scopeId}></path></svg><span data-v-904d8f19${_scopeId}>Tu espacio</span>`);
          } else {
            return [
      ...
      _push(`</div><button class="md:hidden text-[#5D4A44] hover:text-[#D8AFA0] transition-colors p-2" aria-label="Toggle menu" data-v-904d8f19><svg class="${ssrRenderClass([{ "rotate-90": menuOpen.value }, "w-6 h-6 transition-transform duration-300"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-904d8f19>`);
      if (!menuOpen.value) {
        _push(`<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" data-v-904d8f19></path>`);
      } else {
        _push(`<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-904d8f19></path>`);
      }
      _push(`</svg></button></nav>`);
      if (menuOpen.value) {
        _push(`<div class="fixed inset-0 top-20 z-40 bg-[#5D4A44]/10 backdrop-blur-sm md:hidden" data-v-904d8f19><div class="bg-[#F9F7F3] shadow-lg mx-4 mt-4 rounded-2xl p-6" data-v-904d8f19><nav class="flex flex-col gap-3 w-full" data-v-904d8f19>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/",
        ...
        _push(`<div class="h-px bg-[#D8AFA0]/20 my-2" data-v-904d8f19></div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/login",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-904d8f19${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-v-904d8f19${_scopeId}></path></svg><span data-v-904d8f19${_scopeId}>Tu espacio terap\xE9utico</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  class: "w-5 h-5",
        ...
        _push(`</nav><div class="mt-6" data-v-904d8f19>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/reservar",
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-904d8f19"]]);
...
//# sourceMappingURL=default-BfMEigMp.mjs.map
