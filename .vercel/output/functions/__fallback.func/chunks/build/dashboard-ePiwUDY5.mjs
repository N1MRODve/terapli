...
const _sfc_main$5 = {
  ...
  setup(__props) {
    const quotes = [
      {
        text: "Mereces paz, amor y comprensión. Empieza por dártela a ti misma.",
        author: "— Recordatorio de bienestar"
      },
      {
        text: "Eres más fuerte de lo que crees. Confía en tu proceso.",
        author: "— Afirmación del día"
      },
      {
        text: "Está bien no estar bien. Lo importante es permitirte sentir.",
        author: "— Recordatorio de autocuidado"
      },
      {
        text: "Cada paso que das hacia tu bienestar es un acto de amor propio.",
        author: "— Reflexión diaria"
      },
      {
        text: "Tus emociones son mensajeras, no enemigas. Escúchalas con compasión.",
        author: "— Sabiduría emocional"
      },
      {
        text: "El autocuidado no es egoísmo, es responsabilidad hacia ti misma.",
        author: "— Recordatorio de bienestar"
      },
      {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (nextSession.value) {
        ...
        _push(`<div class="text-center py-6"><div class="inline-block mb-3 text-4xl opacity-30">📅</div><p class="font-[&#39;Lato&#39;] text-sm text-[#5D4A44]/60 mb-3"> No tienes sesiones programadas próximamente </p><button class="px-5 py-2 rounded-full bg-[#D8AFA0] text-white font-medium text-sm hover:bg-[#C99F90] transition-all duration-300 ease-in-out hover:scale-105" style="${ssrRenderStyle({ "font-family": "'Lato', sans-serif" })}"> Agendar sesión </button></div>`);
      }
      _push(`</div>`);
    };
  }
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white rounded-2xl shadow-[0_2px_6px_rgba(0,0,0,0.05)] border border-[#EAD5D3]/30 p-6" }, _attrs))} data-v-2fde22bb><h2 class="font-[&#39;Lora&#39;] text-2xl text-[#5D4A44] mb-6" data-v-2fde22bb> ¿Cómo te sientes hoy? </h2>`);
      if (!submitted.value) {
        ...
        _push(`<!--]--></div></div><div class="mb-6" data-v-2fde22bb><p class="font-[&#39;Lato&#39;] text-sm text-[#5D4A44]/70 mb-3" data-v-2fde22bb> Emociones específicas (opcional) </p><div class="flex overflow-x-auto snap-x snap-mandatory gap-2 pb-2 -mx-1 px-1 scrollbar-hide" data-v-2fde22bb><!--[-->`);
        ...
        _push(`<div class="text-center py-8 animate-fadeIn" data-v-2fde22bb><div class="inline-block mb-4 text-6xl animate-float" data-v-2fde22bb>🌿</div><p class="font-[&#39;Lato&#39;] text-base text-[#5D4A44] mb-2" data-v-2fde22bb> Gracias por compartir cómo te sientes hoy. </p><button class="mt-4 px-6 py-2 rounded-full bg-[#D8AFA0]/20 text-[#D8AFA0] font-[&#39;Lato&#39;] text-sm hover:bg-[#D8AFA0]/30 transition-all duration-300 ease-in-out" data-v-2fde22bb> Registrar otro momento </button></div>`);
      }
      _push(`</div>`);
    };
  }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (resources.value.length > 0) {
        ...
        _push(`<div class="text-center py-6" data-v-776bb26f><div class="inline-block mb-3 text-4xl opacity-30" data-v-776bb26f>📚</div><p class="font-[&#39;Lato&#39;] text-sm text-[#5D4A44]/60" data-v-776bb26f> No hay recursos disponibles en este momento </p></div>`);
      }
      _push(`</div>`);
    };
  }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="text-center py-4" data-v-7517bdb5><p class="font-[&#39;Lato&#39;] text-sm text-[#5D4A44]/60" data-v-7517bdb5> Tu bienestar es un camino, no una meta. 🌿 </p></div></div>`);
      }
      _push(`</div>`);
    };
  }
