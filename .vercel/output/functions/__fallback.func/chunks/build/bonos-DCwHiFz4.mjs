...
import { u as useBonos, a as useRoles } from './useBonos-DTBWQlOT.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { i as useRoute, a as useRouter, g as useSupabaseClient, e as useSupabase } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["bono-card bg-[#F9F7F3] border-2 rounded-xl p-5 hover:shadow-lg transition-all duration-300", [unref(borderColor), { "opacity-60": __props.bono.estado === "cancelado" }]]
      }, _attrs))} data-v-b1b873d2><div class="flex items-start justify-between mb-4" data-v-b1b873d2><div class="flex-1" data-v-b1b873d2><div class="flex items-center gap-3 mb-2" data-v-b1b873d2><span class="text-2xl" data-v-b1b873d2>\u{1F3AB}</span><h3 class="font-[&#39;Lora&#39;] text-xl font-semibold text-[#5D4A44]" data-v-b1b873d2> Bono ${ssrInterpolate(unref(tipoTexto))}</h3></div><div class="flex items-center gap-2" data-v-b1b873d2><span class="${ssrRenderClass([unref(estadoColor), "inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border"])}" data-v-b1b873d2>${ssrInterpolate(unref(estadoIcono))} ${ssrInterpolate(unref(estadoTexto))}</span>`);
      if (unref(proximoAVencer)) {
        _push(`<span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-700 border border-orange-300" data-v-b1b873d2> \u26A0\uFE0F Vence pronto </span>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(pocasSesiones)) {
        _push(`<span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-700 border border-blue-300" data-v-b1b873d2> \u{1F4CA} Pocas sesiones </span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="flex gap-2" data-v-b1b873d2>`);
      if (unref(puedeVerPagos)) {
        _push(`<button class="p-2 hover:bg-[#D8AFA0]/20 rounded-lg transition-colors" title="Ver pagos" data-v-b1b873d2><span class="text-lg" data-v-b1b873d2>\u{1F4B0}</span></button>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(puedeRenovar)) {
        _push(`<button class="p-2 hover:bg-[#D8AFA0]/20 rounded-lg transition-colors" title="Renovar bono" data-v-b1b873d2><span class="text-lg" data-v-b1b873d2>\u{1F504}</span></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="mb-4" data-v-b1b873d2><div class="flex items-center justify-between mb-2" data-v-b1b873d2><span class="text-sm text-[#5D4A44]/70" data-v-b1b873d2>Sesiones</span><span class="text-sm font-semibold text-[#5D4A44]" data-v-b1b873d2>${ssrInterpolate(unref(sesionesRestantes))} / ${ssrInterpolate(__props.bono.sesiones_totales)} disponibles </span></div><div class="w-full bg-gray-200 rounded-full h-3" data-v-b1b873d2><div class="${ssrRenderClass([unref(barraProgresoColor), "h-3 rounded-full transition-all duration-500"])}" style="${ssrRenderStyle({ width: unref(porcentajeUsado) + "%" })}" data-v-b1b873d2></div></div><div class="flex justify-between mt-1 text-xs text-[#5D4A44]/60" data-v-b1b873d2><span data-v-b1b873d2>${ssrInterpolate(unref(sesionesUsadas))} usadas</span><span data-v-b1b873d2>${ssrInterpolate(unref(porcentajeUsado))}% completado</span></div></div><div class="grid grid-cols-2 gap-3 mb-4" data-v-b1b873d2><div class="p-3 bg-white rounded-lg border border-[#D8AFA0]/20" data-v-b1b873d2><div class="text-xs text-[#5D4A44]/60 mb-1" data-v-b1b873d2>Tipo</div><div class="text-sm font-medium text-[#5D4A44] capitalize" data-v-b1b873d2>${ssrInterpolate(__props.bono.tipo || "Est\xE1ndar")}</div></div><div class="p-3 bg-white rounded-lg border border-[#D8AFA0]/20" data-v-b1b873d2><div class="text-xs text-[#5D4A44]/60 mb-1" data-v-b1b873d2>Frecuencia</div><div class="text-sm font-medium text-[#5D4A44] capitalize" data-v-b1b873d2>${ssrInterpolate(__props.bono.frecuencia || "Semanal")}</div></div><div class="p-3 bg-white rounded-lg border border-[#D8AFA0]/20" data-v-b1b873d2><div class="text-xs text-[#5D4A44]/60 mb-1" data-v-b1b873d2>Monto</div><div class="text-sm font-medium text-[#5D4A44]" data-v-b1b873d2>${ssrInterpolate(formatearMonto(__props.bono.monto))}</div></div><div class="p-3 bg-white rounded-lg border border-[#D8AFA0]/20" data-v-b1b873d2><div class="text-xs text-[#5D4A44]/60 mb-1" data-v-b1b873d2>Pago</div><div class="${ssrRenderClass([__props.bono.pagado ? "text-green-600" : "text-orange-600", "text-sm font-medium flex items-center gap-1"])}" data-v-b1b873d2>${ssrInterpolate(__props.bono.pagado ? "\u2713 Pagado" : "\u23F3 Pendiente")}</div></div></div>`);
      if (__props.bono.fecha_inicio || __props.bono.fecha_fin) {
        _push(`<div class="mb-4 p-3 bg-gradient-to-r from-[#D8AFA0]/10 to-[#ECC8BA]/10 rounded-lg" data-v-b1b873d2><div class="flex items-center justify-between text-sm" data-v-b1b873d2>`);
        if (__props.bono.fecha_inicio) {
          _push(`<div data-v-b1b873d2><span class="text-[#5D4A44]/60" data-v-b1b873d2>Inicio:</span><span class="font-medium text-[#5D4A44] ml-1" data-v-b1b873d2>${ssrInterpolate(formatearFecha(__props.bono.fecha_inicio))}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.bono.fecha_fin) {
          _push(`<div data-v-b1b873d2><span class="text-[#5D4A44]/60" data-v-b1b873d2>Vence:</span><span class="${ssrRenderClass([unref(proximoAVencer) ? "text-orange-600" : "text-[#5D4A44]", "font-medium ml-1"])}" data-v-b1b873d2>${ssrInterpolate(formatearFecha(__props.bono.fecha_fin))}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (unref(diasRestantes) !== null && __props.bono.estado === "activo") {
          _push(`<div class="mt-2 text-xs text-center text-[#5D4A44]/60" data-v-b1b873d2>${ssrInterpolate(unref(diasRestantes) > 0 ? `${unref(diasRestantes)} d\xEDas restantes` : "Vencido")}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (__props.bono.renovacion_automatica) {
        _push(`<div class="flex items-center gap-2 mb-4 p-2 bg-purple-50 border border-purple-200 rounded-lg" data-v-b1b873d2><span class="text-sm" data-v-b1b873d2>\u{1F504}</span><span class="text-xs text-purple-700 font-medium" data-v-b1b873d2>Renovaci\xF3n autom\xE1tica activada</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.bono.notas) {
        _push(`<div class="mb-4" data-v-b1b873d2><div class="text-xs text-[#5D4A44]/60 mb-1" data-v-b1b873d2>Notas</div><div class="text-sm text-[#5D4A44]/80 p-2 bg-white rounded-lg border border-[#D8AFA0]/20" data-v-b1b873d2>${ssrInterpolate(__props.bono.notas)}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex gap-2 pt-3 border-t border-[#D8AFA0]/20" data-v-b1b873d2>`);
      if (unref(puedeVerPagos)) {
        _push(`<button class="flex-1 px-4 py-2 bg-[#D8AFA0] text-white rounded-lg hover:bg-[#C89B8A] transition-colors text-sm font-medium flex items-center justify-center gap-2" data-v-b1b873d2><span data-v-b1b873d2>\u{1F4B0}</span><span data-v-b1b873d2>Ver Pagos</span></button>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(puedeRenovar) && __props.bono.estado !== "activo") {
        _push(`<button class="flex-1 px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors text-sm font-medium flex items-center justify-center gap-2" data-v-b1b873d2><span data-v-b1b873d2>\u{1F504}</span><span data-v-b1b873d2>Renovar</span></button>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(puedeEditar)) {
        _push(`<button class="px-4 py-2 bg-white border border-[#D8AFA0]/30 text-[#5D4A44] rounded-lg hover:bg-[#D8AFA0]/10 transition-colors text-sm font-medium" data-v-b1b873d2> \u270F\uFE0F </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-b1b873d2"]]), { __name: "BonoCard" });
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.mostrar) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" }, _attrs))} data-v-f2590954><div class="bg-[#F9F7F3] rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto" data-v-f2590954><div class="sticky top-0 bg-[#F9F7F3] border-b border-[#D8AFA0]/30 px-6 py-4" data-v-f2590954><div class="flex justify-between items-start" data-v-f2590954><div class="flex-1" data-v-f2590954><h2 class="text-2xl font-[&#39;Lora&#39;] text-[#5D4A44] font-semibold flex items-center gap-2" data-v-f2590954><span class="text-2xl" data-v-f2590954>\u{1F4B0}</span> Pagos del Bono </h2><p class="text-sm text-[#5D4A44]/60 mt-1" data-v-f2590954> Gestiona los pagos y confirma transacciones </p></div><button class="text-[#5D4A44] hover:text-[#D8AFA0] transition-colors" aria-label="Cerrar modal" data-v-f2590954><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f2590954><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-f2590954></path></svg></button></div>`);
        if (__props.bono) {
          _push(`<div class="mt-4 p-4 bg-gradient-to-r from-[#D8AFA0]/10 to-[#ECC8BA]/10 rounded-lg" data-v-f2590954><div class="grid grid-cols-3 gap-4 text-sm" data-v-f2590954><div data-v-f2590954><div class="text-[#5D4A44]/60 mb-1" data-v-f2590954>Tipo</div><div class="font-medium text-[#5D4A44] capitalize" data-v-f2590954>${ssrInterpolate(__props.bono.tipo)}</div></div><div data-v-f2590954><div class="text-[#5D4A44]/60 mb-1" data-v-f2590954>Monto Total</div><div class="font-bold text-[#D8AFA0] text-lg" data-v-f2590954>${ssrInterpolate(formatearMonto(__props.bono.monto))}</div></div><div data-v-f2590954><div class="text-[#5D4A44]/60 mb-1" data-v-f2590954>Estado</div><div class="${ssrRenderClass([__props.bono.pagado ? "text-green-600" : "text-orange-600", "font-medium capitalize"])}" data-v-f2590954>${ssrInterpolate(__props.bono.pagado ? "\u2713 Pagado" : "\u23F3 Pendiente")}</div></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="px-6 py-6 space-y-6" data-v-f2590954><div class="p-4 bg-white border-2 border-[#D8AFA0]/30 rounded-xl" data-v-f2590954><div class="grid grid-cols-3 gap-4 text-center" data-v-f2590954><div data-v-f2590954><div class="text-2xl font-bold text-green-600" data-v-f2590954>${ssrInterpolate(formatearMonto(unref(totalPagado)))}</div><div class="text-xs text-[#5D4A44]/60 mt-1" data-v-f2590954>Total Pagado</div></div><div data-v-f2590954><div class="text-2xl font-bold text-orange-600" data-v-f2590954>${ssrInterpolate(formatearMonto(unref(montoPendiente)))}</div><div class="text-xs text-[#5D4A44]/60 mt-1" data-v-f2590954>Pendiente</div></div><div data-v-f2590954><div class="text-2xl font-bold text-[#5D4A44]" data-v-f2590954>${ssrInterpolate(unref(pagos).length)}</div><div class="text-xs text-[#5D4A44]/60 mt-1" data-v-f2590954>Transacciones</div></div></div><div class="mt-4" data-v-f2590954><div class="flex justify-between text-xs text-[#5D4A44]/60 mb-1" data-v-f2590954><span data-v-f2590954>Progreso de pago</span><span data-v-f2590954>${ssrInterpolate(unref(porcentajePagado))}%</span></div><div class="w-full bg-gray-200 rounded-full h-2" data-v-f2590954><div class="${ssrRenderClass([unref(porcentajePagado) >= 100 ? "bg-green-500" : "bg-gradient-to-r from-[#D8AFA0] to-[#ECC8BA]", "h-2 rounded-full transition-all duration-500"])}" style="${ssrRenderStyle({ width: Math.min(unref(porcentajePagado), 100) + "%" })}" data-v-f2590954></div></div></div></div>`);
        if (unref(puedeGestionarBonos)) {
          _push(`<div class="flex justify-end" data-v-f2590954><button class="px-4 py-2 bg-[#D8AFA0] text-white rounded-lg hover:bg-[#C89B8A] transition-colors font-medium flex items-center gap-2" data-v-f2590954><span data-v-f2590954>${ssrInterpolate(unref(mostrarFormularioPago) ? "\u2715" : "+")}</span><span data-v-f2590954>${ssrInterpolate(unref(mostrarFormularioPago) ? "Cancelar" : "Registrar Pago")}</span></button></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(mostrarFormularioPago)) {
          _push(`<div class="p-5 bg-green-50 border-2 border-green-300 rounded-xl" data-v-f2590954><h3 class="font-[&#39;Lora&#39;] text-lg font-semibold text-[#5D4A44] mb-4 flex items-center gap-2" data-v-f2590954><span data-v-f2590954>\u{1F4B3}</span> Registrar Nuevo Pago </h3><form class="space-y-4" data-v-f2590954><div class="grid grid-cols-2 gap-4" data-v-f2590954><div data-v-f2590954><label class="block text-sm font-medium text-[#5D4A44] mb-2" data-v-f2590954> Monto <span class="text-red-500" data-v-f2590954>*</span></label><div class="relative" data-v-f2590954><span class="absolute left-3 top-1/2 -translate-y-1/2 text-[#5D4A44]/60" data-v-f2590954>\u20AC</span><input${ssrRenderAttr("value", unref(nuevoPago).monto)} type="number" min="0" step="0.01" required placeholder="0.00" class="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D8AFA0] bg-white" data-v-f2590954></div></div><div data-v-f2590954><label class="block text-sm font-medium text-[#5D4A44] mb-2" data-v-f2590954> M\xE9todo de Pago <span class="text-red-500" data-v-f2590954>*</span></label><select required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D8AFA0] bg-white" data-v-f2590954><option value="" data-v-f2590954${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "") : ssrLooseEqual(unref(nuevoPago).metodo, "")) ? " selected" : ""}>Seleccionar m\xE9todo</option><option value="efectivo" data-v-f2590954${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "efectivo") : ssrLooseEqual(unref(nuevoPago).metodo, "efectivo")) ? " selected" : ""}>\u{1F4B5} Efectivo</option><option value="transferencia" data-v-f2590954${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "transferencia") : ssrLooseEqual(unref(nuevoPago).metodo, "transferencia")) ? " selected" : ""}>\u{1F3E6} Transferencia</option><option value="tarjeta" data-v-f2590954${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "tarjeta") : ssrLooseEqual(unref(nuevoPago).metodo, "tarjeta")) ? " selected" : ""}>\u{1F4B3} Tarjeta</option><option value="bizum" data-v-f2590954${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "bizum") : ssrLooseEqual(unref(nuevoPago).metodo, "bizum")) ? " selected" : ""}>\u{1F4F1} Bizum</option><option value="paypal" data-v-f2590954${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).metodo) ? ssrLooseContain(unref(nuevoPago).metodo, "paypal") : ssrLooseEqual(unref(nuevoPago).metodo, "paypal")) ? " selected" : ""}>\u{1F17F}\uFE0F PayPal</option></select></div></div>`);
          if (unref(puedeConfirmarPagos)) {
            _push(`<div class="flex items-center gap-2 p-3 bg-white border border-green-300 rounded-lg" data-v-f2590954><input${ssrIncludeBooleanAttr(Array.isArray(unref(nuevoPago).confirmado) ? ssrLooseContain(unref(nuevoPago).confirmado, null) : unref(nuevoPago).confirmado) ? " checked" : ""} type="checkbox" id="confirmar-pago" class="w-4 h-4 text-green-600 border-gray-300 rounded focus:ring-green-500" data-v-f2590954><label for="confirmar-pago" class="text-sm text-[#5D4A44] cursor-pointer" data-v-f2590954> \u2713 Confirmar pago inmediatamente (ya verificado) </label></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="flex gap-3" data-v-f2590954><button type="button" class="flex-1 px-4 py-2 bg-white border border-gray-300 text-[#5D4A44] rounded-lg hover:bg-gray-50 transition-colors" data-v-f2590954> Cancelar </button><button type="submit" class="flex-1 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors font-medium disabled:opacity-50"${ssrIncludeBooleanAttr(unref(guardandoPago)) ? " disabled" : ""} data-v-f2590954>${ssrInterpolate(unref(guardandoPago) ? "Registrando..." : "Guardar Pago")}</button></div></form></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div data-v-f2590954><h3 class="font-[&#39;Lora&#39;] text-lg font-semibold text-[#5D4A44] mb-4 flex items-center gap-2" data-v-f2590954><span data-v-f2590954>\u{1F4DC}</span> Historial de Pagos (${ssrInterpolate(unref(pagos).length)}) </h3>`);
        if (unref(cargando)) {
          _push(`<div class="text-center py-8" data-v-f2590954><div class="animate-spin w-10 h-10 border-4 border-[#D8AFA0] border-t-transparent rounded-full mx-auto mb-3" data-v-f2590954></div><p class="text-[#5D4A44]/60" data-v-f2590954>Cargando pagos...</p></div>`);
        } else if (unref(pagos).length === 0) {
          _push(`<div class="text-center py-12" data-v-f2590954><span class="text-6xl mb-3 block opacity-40" data-v-f2590954>\u{1F4B8}</span><p class="text-[#5D4A44]/60" data-v-f2590954>No hay pagos registrados a\xFAn</p></div>`);
        } else {
          _push(`<div class="space-y-3" data-v-f2590954><!--[-->`);
          ssrRenderList(unref(pagosOrdenados), (pago) => {
            _push(`<div class="${ssrRenderClass([pago.confirmado ? "bg-green-50 border-green-300" : "bg-yellow-50 border-yellow-300", "p-4 border-2 rounded-lg transition-all"])}" data-v-f2590954><div class="flex items-start justify-between gap-4" data-v-f2590954><div class="flex-1" data-v-f2590954><div class="flex items-center gap-3 mb-2" data-v-f2590954><span class="${ssrRenderClass([pago.confirmado ? "text-green-600" : "text-yellow-600", "text-2xl font-bold"])}" data-v-f2590954>${ssrInterpolate(formatearMonto(pago.monto))}</span><span class="${ssrRenderClass([pago.confirmado ? "bg-green-200 text-green-800" : "bg-yellow-200 text-yellow-800", "px-2 py-1 rounded-full text-xs font-medium capitalize"])}" data-v-f2590954>${ssrInterpolate(pago.confirmado ? "\u2713 Confirmado" : "\u23F3 Pendiente")}</span></div><div class="space-y-1 text-sm text-[#5D4A44]/70" data-v-f2590954><div class="flex items-center gap-2" data-v-f2590954><span data-v-f2590954>\u{1F4B3}</span><span class="capitalize" data-v-f2590954>${ssrInterpolate(obtenerMetodoPagoTexto(pago.metodo_pago))}</span></div><div class="flex items-center gap-2" data-v-f2590954><span data-v-f2590954>\u{1F4C5}</span><span data-v-f2590954>${ssrInterpolate(formatearFecha(pago.fecha_pago))}</span></div>`);
            if (pago.confirmado && pago.fecha_confirmacion) {
              _push(`<div class="flex items-center gap-2" data-v-f2590954><span data-v-f2590954>\u2705</span><span data-v-f2590954>Confirmado el ${ssrInterpolate(formatearFecha(pago.fecha_confirmacion))}</span></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div></div>`);
            if (unref(puedeConfirmarPagos) && !pago.confirmado) {
              _push(`<div data-v-f2590954><button class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors text-sm font-medium"${ssrIncludeBooleanAttr(unref(confirmandoPago) === pago.id) ? " disabled" : ""} data-v-f2590954>${ssrInterpolate(unref(confirmandoPago) === pago.id ? "Confirmando..." : "\u2713 Confirmar")}</button></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div></div>`);
        ...
        _push(`</div>`);
        if (unref(errorMensaje)) {
          _push(`<div class="p-4 bg-red-50 border border-red-200 rounded-lg" data-v-f2590954><p class="text-sm text-red-700 flex items-center gap-2" data-v-f2590954><span data-v-f2590954>\u274C</span> ${ssrInterpolate(unref(errorMensaje))}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(exitoMensaje)) {
          _push(`<div class="p-4 bg-green-50 border border-green-200 rounded-lg" data-v-f2590954><p class="text-sm text-green-700 flex items-center gap-2" data-v-f2590954><span data-v-f2590954>\u2705</span> ${ssrInterpolate(unref(exitoMensaje))}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="sticky bottom-0 bg-[#F9F7F3] border-t border-[#D8AFA0]/30 px-6 py-4" data-v-f2590954><button class="w-full px-6 py-3 bg-[#5D4A44] text-white rounded-lg hover:bg-[#4A3A34] transition-colors font-medium" data-v-f2590954> Cerrar </button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-f2590954"]]), { __name: "ModalPagosBono" });
...
//# sourceMappingURL=bonos-DCwHiFz4.mjs.map
