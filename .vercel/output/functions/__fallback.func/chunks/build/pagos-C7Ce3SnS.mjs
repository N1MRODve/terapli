        ...
        ssrRenderList(unref(bonosPendientesFiltrados), (bono) => {
          ...
          if (bono.sesiones_restantes <= 1) {
            _push(`<div class="${ssrRenderClass([{
              "text-red-600": bono.sesiones_restantes === 0,
              "text-orange-600": bono.sesiones_restantes === 1
            }, "flex items-center gap-1 text-xs font-semibold mt-1"])}" data-v-efdf5c5d><svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-efdf5c5d><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" data-v-efdf5c5d></path><path d="M12 9v4" data-v-efdf5c5d></path><path d="M12 17h.01" data-v-efdf5c5d></path></svg><span data-v-efdf5c5d>${ssrInterpolate(bono.sesiones_restantes === 0 ? "\xA1AGOTADO!" : "\xA1\xDALTIMA!")}</span></div>`);
          } else {
            _push(`<!---->`);
          }
