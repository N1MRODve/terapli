...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-3xl mx-auto pb-20" }, _attrs))}><button class="mb-6 flex items-center gap-2 text-cafe hover:text-terracota transition-colors"><span>\u2190</span><span>Volver a lista de pacientes</span></button><div class="mb-8"><h1 class="text-3xl font-serif font-bold text-cafe mb-2"> Nuevo Paciente </h1><p class="text-cafe/60"> Completa la informaci\xF3n del nuevo paciente </p></div><div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6"><form class="space-y-6"><div><label class="block text-sm font-medium text-cafe mb-2"> Nombre Completo <span class="text-red-500">*</span></label><input${ssrRenderAttr("value", unref(form).nombre_completo)} type="text" required placeholder="Ej: Mar\xEDa Garc\xEDa L\xF3pez" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-terracota focus:border-transparent"></div><div><label class="block text-sm font-medium text-cafe mb-2"> Email <span class="text-red-500">*</span></label><input${ssrRenderAttr("value", unref(form).email)} type="email" required placeholder="ejemplo@correo.com" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-terracota focus:border-transparent"></div><div><label class="block text-sm font-medium text-cafe mb-2"> Tel\xE9fono </label><input${ssrRenderAttr("value", unref(form).telefono)} type="tel" placeholder="+34 600 000 000" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-terracota focus:border-transparent"><p class="text-xs text-gray-500 mt-1"> Incluye el c\xF3digo de pa\xEDs para WhatsApp </p></div><div><label class="block text-sm font-medium text-cafe mb-2"> \xC1rea de Acompa\xF1amiento </label><select class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-terracota focus:border-transparent"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "") : ssrLooseEqual(unref(form).area_de_acompanamiento, "")) ? " selected" : ""}>Selecciona un \xE1rea</option><option value="Ansiedad"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Ansiedad") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Ansiedad")) ? " selected" : ""}>Ansiedad</option><option value="Depresi\xF3n"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Depresi\xF3n") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Depresi\xF3n")) ? " selected" : ""}>Depresi\xF3n</option><option value="Duelo"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Duelo") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Duelo")) ? " selected" : ""}>Duelo</option><option value="Autoestima"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Autoestima") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Autoestima")) ? " selected" : ""}>Autoestima</option><option value="Relaciones"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Relaciones") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Relaciones")) ? " selected" : ""}>Relaciones</option><option value="Familia"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Familia") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Familia")) ? " selected" : ""}>Familia</option><option value="Trauma"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Trauma") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Trauma")) ? " selected" : ""}>Trauma</option><option value="Estr\xE9s"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Estr\xE9s") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Estr\xE9s")) ? " selected" : ""}>Estr\xE9s</option><option value="Desarrollo Personal"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Desarrollo Personal") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Desarrollo Personal")) ? " selected" : ""}>Desarrollo Personal</option><option value="Otro"${ssrIncludeBooleanAttr(Array.isArray(unref(form).area_de_acompanamiento) ? ssrLooseContain(unref(form).area_de_acompanamiento, "Otro") : ssrLooseEqual(unref(form).area_de_acompanamiento, "Otro")) ? " selected" : ""}>Otro</option></select></div><div><label class="block text-sm font-medium text-cafe mb-2"> Frecuencia de Sesiones </label><select class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-terracota focus:border-transparent"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).frecuencia) ? ssrLooseContain(unref(form).frecuencia, "") : ssrLooseEqual(unref(form).frecuencia, "")) ? " selected" : ""}>Selecciona una frecuencia</option><option value="semanal"${ssrIncludeBooleanAttr(Array.isArray(unref(form).frecuencia) ? ssrLooseContain(unref(form).frecuencia, "semanal") : ssrLooseEqual(unref(form).frecuencia, "semanal")) ? " selected" : ""}>Semanal</option><option value="quincenal"${ssrIncludeBooleanAttr(Array.isArray(unref(form).frecuencia) ? ssrLooseContain(unref(form).frecuencia, "quincenal") : ssrLooseEqual(unref(form).frecuencia, "quincenal")) ? " selected" : ""}>Quincenal</option><option value="mensual"${ssrIncludeBooleanAttr(Array.isArray(unref(form).frecuencia) ? ssrLooseContain(unref(form).frecuencia, "mensual") : ssrLooseEqual(unref(form).frecuencia, "mensual")) ? " selected" : ""}>Mensual</option><option value="ocasional"${ssrIncludeBooleanAttr(Array.isArray(unref(form).frecuencia) ? ssrLooseContain(unref(form).frecuencia, "ocasional") : ssrLooseEqual(unref(form).frecuencia, "ocasional")) ? " selected" : ""}>Ocasional</option></select></div><div><label class="block text-sm font-medium text-cafe mb-2"> Notas Iniciales </label><textarea rows="4" placeholder="Informaci\xF3n relevante sobre el paciente..." class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-terracota focus:border-transparent resize-none">${ssrInterpolate(unref(form).notas_iniciales)}</textarea></div><div class="flex items-center gap-3"><input${ssrIncludeBooleanAttr(Array.isArray(unref(form).activo) ? ssrLooseContain(unref(form).activo, null) : unref(form).activo) ? " checked" : ""} type="checkbox" id="activo" class="w-5 h-5 text-terracota border-gray-300 rounded focus:ring-2 focus:ring-terracota"><label for="activo" class="text-sm font-medium text-cafe cursor-pointer"> Paciente activo </label></div>`);
...
//# sourceMappingURL=nuevo-XgXvDbCO.mjs.map
