      ...
      <header class="sticky top-0 bg-white shadow-sm z-20 flex-shrink-0">
        <div class="px-4 lg:px-8 py-4">
          <div class="flex items-center justify-between gap-4">
            ...
            <div class="hidden md:block flex-1 max-w-md">
              <div class="relative">
                <input
                  ...
                  class="w-full px-4 py-2 pl-10 bg-base-bg rounded-lg border border-transparent focus:border-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-300/20 transition-all text-sm text-cafe placeholder-cafe/50"
                />
            ...
            <!-- Nueva Tarea Button -->
            <button
              class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-600/90 transition-colors duration-200 text-sm font-medium whitespace-nowrap"
            >
              + Nueva tarea
            </button>
            ...
            <!-- User Avatar -->
            <div
              class="w-10 h-10 rounded-full bg-purple-600 text-white flex items-center justify-center font-semibold text-sm flex-shrink-0"
            >
              {{ userInitials }}
            </div>
          </div>
