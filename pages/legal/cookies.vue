...
<script setup>
useHead({
  title: 'Política de Cookies – Psicóloga Karem Peña Ciempozuelos',
  meta: [
    { 
      name: 'description', 
      content: 'Información sobre el uso de cookies y configuración de consentimiento en psicologakarem.com.' 
    },
    { 
      name: 'robots', 
