  ...
  <div class="bg-[#F9F7F3] min-h-screen">
    ...
    <section class="py-20">
      <div class="max-w-5xl mx-auto px-6 text-[#5D4A44]">
        ...
        <!-- Sección 1: Cancelaciones con antelación -->
        ...
        <!-- Sección 2: Cancelaciones tardías -->
        <article class="mb-12 border-b border-[#EAD5D3] pb-12">
          <div class="flex items-start gap-4 mb-4">
            <div class="flex-shrink-0 w-12 h-12 bg-[#D8AFA0]/20 rounded-full flex items-center justify-center">
              <svg class="w-6 h-6 text-[#D8AFA0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script setup>
useHead({
  title: 'Política de Cancelación – Psicóloga Karem Peña Ciempozuelos',
  meta: [
    { 
      name: 'description', 
      content: 'Información sobre cancelación y reprogramación de sesiones con Karem Peña. Política clara, empática y profesional.' 
    },
    { 
      name: 'robots', 
