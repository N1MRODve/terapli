...
-- ============================================================================
-- VERSIÓN: Supabase Dashboard SQL Editor
-- Ejecutar después de aplicar la migración 20251027_fix_crear_paciente_profile.sql
-- Este script verifica que todo esté configurado correctamente
--
-- NOTA: Este script NO usa comandos \echo porque Supabase SQL Editor no los soporta.
--       Cada query se ejecuta independientemente y muestra sus resultados.
-- ============================================================================

-- 1. Verificar que las funciones existen
-- ============================================================================
-- 🔍 1. VERIFICANDO FUNCIONES RPC...
...
-- 
-- 1. Las funciones crear_paciente_simple y crear_paciente_con_profile deben existir
-- 2. La tabla profiles debe tener columnas: id, email, nombre, telefono, rol
-- 3. La tabla pacientes debe tener columna profile_id con foreign key a profiles
-- 4. Los índices deben incluir idx_profiles_email y idx_pacientes_profile_id
-- 5. Deben existir políticas RLS para profiles y pacientes
-- 6. El número de pacientes SIN profile_id debe ser 0 (o corregirlos)
-- 7. El número de emails desincronizados debe ser 0
-- 
-- Si encuentras problemas, consulta FIX_PROFILE_SINCRONIZACION.md
-- ============================================================================
...
-- 
-- INSTRUCCIONES:
-- 1. Descomenta las líneas de abajo (quita /* y */)
-- 2. Ejecuta en SQL Editor
-- 3. Verifica el resultado

/*
-- 🔧 MIGRANDO PACIENTES EXISTENTES...
...
-- Ejecuta nuevamente las verificaciones anteriores para confirmar
*/
