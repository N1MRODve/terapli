-- ============================================================================
-- FIX: Añadir metadata de citas a vista_agenda_terapeutas
-- ============================================================================
-- Fecha: 28 de diciembre de 2025
-- Problema: La vista no incluía el campo metadata de las citas
-- Solución: Añadir c.metadata as cita_metadata a la vista
...
'Vista consolidada de la agenda de terapeutas. Incluye metadata de citas para acceder a precio_sesion, metodo_pago, etc.';
