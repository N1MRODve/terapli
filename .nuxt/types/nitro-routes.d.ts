...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    '/api/admin/crear-terapeuta': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/admin/crear-terapeuta.post').default>>>>
    }
    '/api/pagos/confirmar': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/pagos/confirmar.post').default>>>>
    }
    '/__nuxt_error': {
